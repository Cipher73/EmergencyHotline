...
public class Helpline4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Allow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                locationSettingsResponseTask.addOnCompleteListener(new OnCompleteListener<LocationSettingsResponse>() {
                    ...
                    public void onComplete(@NonNull Task<LocationSettingsResponse> task) {
                        try {
                            ...
                            // GPS ON
                            Toast.makeText(Helpline4.this," LOCATION SAVED! SERVICE ON THE WAY",Toast.LENGTH_LONG).show();
                            ...
                            switch (e.getStatusCode()) {
                                case LocationSettingsStatusCodes
                                    ...
                                    try {
                                        ...
                                        exception.startResolutionForResult(Helpline4.this, RCS);
                ...
                if(ActivityCompat.checkSelfPermission(Helpline4.this, Manifest.permission.ACCESS_FINE_LOCATION)== PackageManager.PERMISSION_GRANTED){
                    providerClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
                        ...
                        public void onComplete(@NonNull Task<Location> task) {
                            ...
                            if(location!=null){
                                ...
                                try {
                                    Geocoder geocoder = new Geocoder(Helpline4.this, Locale.getDefault());
                                    List<Address> addressList= geocoder.getFromLocation(location.getLatitude(),location.getLongitude(),1);
                                    firebaseDatabase= FirebaseDatabase.getInstance();
                                    reference=firebaseDatabase.getReference("Fire Brigade Locations");
                                    ...
                                    e.printStackTrace();
                                    Toast.makeText(Helpline4.this, "Location IS REQUIRED", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                    });
                    ...
                    ActivityCompat.requestPermissions(Helpline4.this,new String[]{Manifest.permission.ACCESS_FINE_LOCATION},44);
                }
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==RCS){
            switch (requestCode){
                case Activity
                        .RESULT_OK:
                    Toast.makeText(Helpline4.this, "Location turned On", Toast.LENGTH_SHORT).show();
                    break;
                case Activity
                        .RESULT_CANCELED:
                    Toast.makeText(Helpline4.this, "location is required", Toast.LENGTH_SHORT).show();
